        ...
        try {
            ...
            if ($N_Vueltas != 0) {
                ...
                if ($N_Vueltas == 1) {
                    ...
                    $sql = "INSERT INTO SESION_MICRO (ID_USUARIO, ID_PERFIL_MICRO, ID_PERFIL_JUEGO, N_VUELTAS, _PUNTAJE, _PRECISION, M_PUNTAJE, M_PRECISION, P_PUNTAJE, P_PRECISION)
                    ...
                    $sql = "SELECT * FROM SESION_MICRO WHERE ID_USUARIO = :id_u AND N_VUELTAS = :n_vueltas";
            ...
            echo "
            <form class='formulario' method='post' action='Sesion_Micro.php?n_vueltas=" . $N_Vueltas . "'>
                ...
                <div class='contenedor'>
                    ...
                    if ($N_Vueltas_link != 0){
                        ...
                        // Se le manda la variable Sesion = 3 porque estamos en Microshot
                        echo "<a class='boton2' href='fin.php?sesion=3&u_vuelta=" . $N_Vueltas_link . "'> Volver </a>";

                    }

                    else {

                        echo "<a class='boton2' href='N_Sesion_Micro.php'> Volver </a>";

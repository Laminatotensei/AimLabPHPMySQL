        ...
        try {
            ...
            while ($registro = $resultado->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo"<div class='contenedor'>
                        ...
                        <a class='botones' href='E_Perfil.php?id=" . $registro['ID'] ."'> EDITAR </a>
                        <a class='botones' href='B_Perfil.php?id=" . $registro['ID'] ."'> BORRAR </a>
            ...
            echo "<br><br> <a class='boton2' href='perfil.php'> Volver </a>";
            echo "</form>";

<?php
    ...
    try {
        ...
        if ($numero_registro != 0) {
           ...
           header("location:Sesion_Spider.php?n_vueltas=0&id_p_j=" . $id_perfil_juego . "'");
            ...
            $consulta = "INSERT INTO PERFIL_SPIDER (ID_USUARIO, M_PUNTAJE, M_PRECISION) VALUE (:id_u, 0, 0)";
